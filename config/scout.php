        ...
        'model-settings' => [
            ...
            Entry::class => [
                ...
                'search-parameters' => [
                    'query_by' => implode(',', [
                        'theme.song.title',
                        'theme.song.title_native',
                        'theme.anime.title',
                        'theme.anime.title_english',
                        'theme.anime.title_native',
                        'theme.anime.synonyms',
            ...
            Video::class => [
                ...
                'search-parameters' => [
                    'query_by' => implode(',', [
                        ...
                        'entries.theme.song.title_native',
                        'entries.theme.anime.title',
                        'entries.theme.anime.title_english',
                        'entries.theme.anime.title_native',
                        'entries.theme.anime.synonyms',
