...
enum ArtistSort implements EnumSort
{
    ...
    public function getSortCriteria(): SortCriteria
    {
        return match ($this) {
            ...
            self::NAME_MAIN => new FieldSortCriteria($this->name, Artist::ATTRIBUTE_NAME),
            self::NAME_MAIN_DESC => new FieldSortCriteria($this->name, Artist::ATTRIBUTE_NAME, SortDirection::DESC),
