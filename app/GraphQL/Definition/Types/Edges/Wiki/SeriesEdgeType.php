...
/**
 * Class SeriesEdgeType.
 */
class SeriesEdgeType extends BaseEdgeType
{
    /**
    ...
    {
        return 'Series edge to use in simple belongs to many relationships';
    }

    /**
     * Get the node type for the edge.
     *
     * @return class-string<SeriesType>
     */
