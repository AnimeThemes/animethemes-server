...
/**
 * Class ResourceArtistEdgeType.
 */
class ResourceArtistEdgeType extends BaseEdgeType
{
    /**
    ...
    {
        return 'Resource Artist edge to use in simple belongs to many relationships';
    }
