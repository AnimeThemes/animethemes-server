...
namespace App\GraphQL\Definition\Types\Edges\Wiki\Image;
...
/**
 * Class ImageArtistEdgeType.
 */
class ImageArtistEdgeType extends BaseEdgeType
{
    /**
    ...
    {
        return 'Image Artist edge to use in simple belongs to many relationships';
    }
