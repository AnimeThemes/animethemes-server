...
class StudioResourceType extends PivotType implements HasRelations, ReportableType
{
    /**
    ...
    {
        return [
            new BelongsToRelation(new StudioType(), StudioResource::RELATION_STUDIO)
                ->notNullable(),
            new BelongsToRelation(new ExternalResourceType(), StudioResource::RELATION_RESOURCE)
                ->notNullable(),
        ];
    }
