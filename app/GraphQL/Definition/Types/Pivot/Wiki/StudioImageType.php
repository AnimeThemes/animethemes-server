 ...
 */
class StudioImageType extends PivotType
{
    /**
    ...
    {
        return [
            new BelongsToRelation(new StudioType(), StudioImage::RELATION_STUDIO, nullable: false),
            new BelongsToRelation(new ImageType(), StudioImage::RELATION_IMAGE, nullable: false),
        ];
    }
