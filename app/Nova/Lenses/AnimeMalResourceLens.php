...
use App\Nova\Actions\CreateExternalResourceForAnimeAction;
...
class AnimeMalResourceLens extends Lens
{
    ...
    {
        return __('nova.anime_mal_resource_lens', ["mal" => ResourceType::getDescription(ResourceType::MAL)]);
    }
    ...
    {
        return [
            (new CreateExternalResourceForAnimeAction(ResourceType::MAL))->canSee(function ($request) {
