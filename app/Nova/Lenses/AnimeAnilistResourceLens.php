...
class AnimeAnilistResourceLens extends Lens
{
    ...
    {
        return __('nova.anime_resource_lens', ["type" => ResourceType::getDescription(ResourceType::ANILIST)]);
    }
    ...
    public static function query(LensRequest $request, $query)
    {
        return Anime::whereDoesntHave('externalResources', function ($resource_query) {
            $resource_query->where('type', ResourceType::ANILIST);
        });
    }
    ...
    {
        return [
            (new CreateExternalResourceTypeForAnimeAction(ResourceType::ANILIST))->canSee(function ($request) {
