 ...
 */
class StudioAnimePlanetResourceLens extends BaseLens
{
    /**
    ...
    {
        return __('nova.studio_resource_lens', ['site' => ResourceSite::getDescription(ResourceSite::ANIME_PLANET)]);
    }
    ...
    {
        return [
            (new CreateExternalResourceSiteForStudioAction(ResourceSite::ANIME_PLANET))
