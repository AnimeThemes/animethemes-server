...
/**
 * Class StudioAnnResourceLens.
 */
class StudioAnnResourceLens extends BaseLens
{
    /**
    ...
    {
        return __('nova.studio_resource_lens', ['site' => ResourceSite::getDescription(ResourceSite::ANN)]);
    }
    ...
    {
        return [
            (new CreateExternalResourceSiteForStudioAction(ResourceSite::ANN))->canSee(function (Request $request) {
                $user = $request->user();
    ...
    {
        return 'studio-ann-resource-lens';
    }
}
