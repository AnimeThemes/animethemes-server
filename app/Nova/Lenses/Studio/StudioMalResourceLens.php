...
/**
 * Class StudioMalResourceLens.
 */
class StudioMalResourceLens extends BaseLens
{
    /**
    ...
    {
        return __('nova.studio_resource_lens', ['site' => ResourceSite::getDescription(ResourceSite::MAL)]);
    }
    ...
    {
        return 'studio-mal-resource-lens';
    }
}
