...
use App\Models\User\Submission\SubmissionStage as SubmissionStageModel;
...
class SubmissionStage extends BaseResource
{
    /**
     ...
     */
    protected static ?string $model = SubmissionStageModel::class;
    ...
    {
        return SubmissionStageModel::ATTRIBUTE_ID;
    }
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        return $query->with([
            SubmissionStageModel::RELATION_SUBMISSION,
        ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return parent::table($table)
            ->columns([
                TextColumn::make(SubmissionStageModel::ATTRIBUTE_ID)
                    ->label(__('filament.fields.base.id')),

                BelongsToColumn::make(SubmissionStageModel::RELATION_SUBMISSION, SubmissionResource::class),
            ]);
    }
        ...
        return $schema
            ->components([
                Section::make(static::getRecordTitle($schema->getRecord()))
                    ->schema([
                        TextEntry::make(SubmissionStageModel::ATTRIBUTE_ID)
                            ->label(__('filament.fields.base.id')),

                        BelongsToEntry::make(SubmissionStageModel::RELATION_SUBMISSION, SubmissionResource::class)
