...
class ScriptResource extends BaseResource
{
     ...
     */
    protected static ?string $model = VideoScript::class;
    ...
    {
        return VideoScript::ATTRIBUTE_PATH;
    }
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema
            ->components([
                TextInput::make(VideoScript::ATTRIBUTE_PATH)
    ...
    public static function table(Table $table): Table
    {
        return parent::table($table)
            ->columns([
                TextColumn::make(VideoScript::ATTRIBUTE_ID)
                    ->label(__('filament.fields.base.id')),

                TextColumn::make(VideoScript::ATTRIBUTE_PATH)
                    ->label(__('filament.fields.video_script.path'))
                    ->copyableWithMessage(),
            ]);
    }
