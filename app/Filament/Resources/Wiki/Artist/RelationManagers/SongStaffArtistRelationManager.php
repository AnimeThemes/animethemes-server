...
class SongStaffArtistRelationManager extends SongStaffRelationManager
{
    /**
     * The relationship the relation manager corresponds to.
     */
    protected static string $relationship = Artist::RELATION_SONG_STAFF;
    ...
    public static function getHeaderActions(): array
    {
        return [
            CreateAction::make('new-song-staff')
                ->after(fn (SongStaff $record): SongStaff => $record->moveToEnd()),
        ];
    }
}
