...
class UserResource extends BaseResource
{
    ...
    public static function table(Table $table): Table
    {
        return parent::table($table)
            ->columns([
                TextColumn::make(User::ATTRIBUTE_ID)
                ...
                TextColumn::make(User::ATTRIBUTE_NAME)
                    ->label(__('filament.fields.user.name'))
                    ->searchable()
                    ->copyableWithMessage(),

                TextColumn::make(User::ATTRIBUTE_EMAIL)
                    ->label(__('filament.fields.user.email'))
            ...
            ->components([
                Section::make(static::getRecordTitle($schema->getRecord()))
                    ->schema([
                        ...
                        TextEntry::make(User::ATTRIBUTE_NAME)
                            ->label(__('filament.fields.user.name'))
                            ->copyableWithMessage(),

                        TextEntry::make(User::ATTRIBUTE_EMAIL)
                            ->label(__('filament.fields.user.email'))
                            ->icon(Heroicon::Envelope),
