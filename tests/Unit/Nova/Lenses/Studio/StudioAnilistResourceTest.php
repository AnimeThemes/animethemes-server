...
/**
 * Class StudioAnilistResourceTest.
 */
class StudioAnilistResourceTest extends TestCase
{
    use NovaLensTest;
    use WithFaker;
    use WithoutEvents;
    ...
    /**
     * The Studio Anilist Resource Lens shall contain Studio Fields.
     *
     * @return void
     *
    ...
    {
        $lens = static::novaLens(StudioAnilistResourceLens::class);
    ...
    /**
     * The Studio Anilist Resource Lens fields shall be sortable.
     *
     * @return void
     *
    ...
    /**
     * The Studio Anilist Resource Lens shall contain Studio Filters.
     *
     * @return void
     *
     * @throws InvalidNovaLensException
    ...
    /**
     * The Studio Anilist Resource Lens shall use the 'withFilters' request.
     *
     * @return void
     *
    ...
    /**
     * The Studio Anilist Resource Lens shall use the 'withOrdering' request.
     *
     * @return void
     *
     * @throws InvalidModelException
    ...
    /**
     * The Studio Anilist Resource Lens shall filter Studio without an Anilist Resource.
     *
     * @return void
     *
     * @throws InvalidModelException
