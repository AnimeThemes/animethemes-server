...
/**
 * Class StudioAniDbResourceTest.
 */
class StudioAniDbResourceTest extends TestCase
{
    use NovaLensTest;
    use WithFaker;
    use WithoutEvents;
    ...
    /**
     * The Studio AniDb Resource Lens shall contain Studio Fields.
     *
     * @return void
     *
    ...
    /**
     * The Studio AniDb Resource Lens fields shall be sortable.
     *
     * @return void
     *
    ...
    /**
     * The Studio AniDb Resource Lens shall contain Studio Filters.
     *
     * @return void
     *
     * @throws InvalidNovaLensException
    ...
    /**
     * The Studio AniDb Resource Lens shall use the 'withFilters' request.
     *
     * @return void
     *
    ...
    /**
     * The Studio AniDb Resource Lens shall use the 'withOrdering' request.
     *
     * @return void
     *
     * @throws InvalidModelException
    ...
    /**
     * The Studio AniDb Resource Lens shall filter Studio without an AniDb Resource.
     *
     * @return void
     *
     * @throws InvalidModelException
