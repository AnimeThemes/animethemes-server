...
test('image created sends discord notification', function (): void {
...
test('image deleted sends discord notification', function (): void {
...
test('image restored sends discord notification', function (): void {
    $image = Image::factory()->createOne();
...
test('image updated sends discord notification', function (): void {
    $image = Image::factory()->createOne();
