...
class PageIndexTest extends TestCase
{
    ...
    public function testDefault(): void
    {
        ...
        $response->assertJson(
            json_decode(
                json_encode(
                    PageCollection::make($pages, PageQuery::make())
                        ->response()
                        ->getData()
                ),
                true
    ...
    public function testSparseFieldsets(): void
    {
        ...
        $response->assertJson(
            json_decode(
                json_encode(
                    PageCollection::make($pages, PageQuery::make($parameters))
                        ->response()
                        ->getData()
                ),
                true
    ...
    public function testSorts(): void
    {
        ...
        $query = PageQuery::make($parameters);
    ...
    public function testCreatedAtFilter(): void
    {
        ...
        $response->assertJson(
            json_decode(
                json_encode(
                    PageCollection::make($page, PageQuery::make($parameters))
                        ->response()
                        ->getData()
                ),
                true
