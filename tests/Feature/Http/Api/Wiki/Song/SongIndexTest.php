...
class SongIndexTest extends TestCase
{
    ...
    public function testDefault(): void
    {
        ...
        $response->assertJson(
            json_decode(
                json_encode(
                    SongCollection::make($songs, new SongQuery())
                        ->response()
                        ->getData()
                ),
                true
    ...
    public function testAllowedIncludePaths(): void
    {
        ...
        $response->assertJson(
            json_decode(
                json_encode(
                    SongCollection::make($songs, new SongQuery($parameters))
                        ->response()
                        ->getData()
                ),
                true
    ...
    public function testSorts(): void
    {
        ...
        $query = new SongQuery($parameters);
    ...
    public function testCreatedAtFilter(): void
    {
        ...
        $response->assertJson(
            json_decode(
                json_encode(
                    SongCollection::make($song, new SongQuery($parameters))
                        ->response()
                        ->getData()
                ),
                true
