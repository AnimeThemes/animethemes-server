...
test('sorts', function (): void {
    ...
    $entries = $this->sort(Entry::query(), $query, $schema)->get();
...
test('created at filter', function (): void {
    ...
    $entry = Entry::query()->where(BaseModel::ATTRIBUTE_CREATED_AT, $createdFilter)->get();
...
test('updated at filter', function (): void {
    ...
    $entry = Entry::query()->where(BaseModel::ATTRIBUTE_UPDATED_AT, $updatedFilter)->get();
...
test('deleted at filter', function (): void {
    ...
    $entry = Entry::withTrashed()->where(ModelConstants::ATTRIBUTE_DELETED_AT, $deletedFilter)->get();
...
test('entries by nsfw', function (): void {
    ...
    $entries = Entry::query()->where(Entry::ATTRIBUTE_NSFW, $nsfwFilter)->get();
...
test('entries by spoiler', function (): void {
    ...
    $entries = Entry::query()->where(Entry::ATTRIBUTE_SPOILER, $spoilerFilter)->get();
...
test('entries by version', function (): void {
    ...
    $entries = Entry::query()->where(Entry::ATTRIBUTE_VERSION, $versionFilter)->get();
