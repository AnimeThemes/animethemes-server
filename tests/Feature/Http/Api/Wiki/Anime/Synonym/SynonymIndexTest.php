...
class SynonymIndexTest extends TestCase
{
    ...
    public function testDefault(): void
    {
        ...
        $response->assertJson(
            json_decode(
                json_encode(
                    SynonymCollection::make($synonyms, new SynonymReadQuery())
                        ->response()
                        ->getData()
                ),
                true
    ...
    public function testAllowedIncludePaths(): void
    {
        ...
        $response->assertJson(
            json_decode(
                json_encode(
                    SynonymCollection::make($synonyms, new SynonymReadQuery($parameters))
                        ->response()
                        ->getData()
                ),
                true
    ...
    public function testCreatedAtFilter(): void
    {
        ...
        $response->assertJson(
            json_decode(
                json_encode(
                    SynonymCollection::make($synonym, new SynonymReadQuery($parameters))
                        ->response()
                        ->getData()
                ),
                true
