...
test('private playlist cannot be publicly viewed', function () {
    ...
    $response = get(route('api.playlist.track.forward', ['playlist' => $playlist, 'track' => $track]));
...
test('allowed include paths', function () {
    ...
    $response = get(route('api.playlist.track.forward', ['playlist' => $playlist, 'track' => $track] + $parameters));
