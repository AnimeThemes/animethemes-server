...
namespace Tests\Feature\Http\Api\List\Playlist\Backward;
...
class BackwardIndexTest extends TestCase
{
    ...
    public function testDefault(): void
    {
        ...
        $response->assertJson(
            json_decode(
                json_encode(
                    (new TrackCollection($playlist->tracks->sortByDesc(PlaylistTrack::ATTRIBUTE_ID), new BackwardReadQuery($playlist)))
                        ->response()
                        ->getData()
                ),
                true
    ...
    public function testAllowedIncludePaths(): void
    {
        ...
        $response->assertJson(
            json_decode(
                json_encode(
                    (new TrackCollection($tracks, new BackwardReadQuery($playlist, $parameters)))
                        ->response()
                        ->getData()
                ),
                true
    ...
    public function testSparseFieldsets(): void
    {
        ...
        $response->assertJson(
            json_decode(
                json_encode(
                    (new TrackCollection($playlist->tracks->sortByDesc(PlaylistTrack::ATTRIBUTE_ID), new BackwardReadQuery($playlist, $parameters)))
                        ->response()
                        ->getData()
                ),
                true
