...
class ExternalProfileIndexTest extends TestCase
{
    ...
    /**
     * The External Profile Index Endpoint shall support filtering by trashed.
     *
     * @return void
     */
    public function testWithoutTrashedFilter(): void
    {
        ...
        $profiles = ExternalProfile::withoutTrashed()->get();
    ...
    public function testWithTrashedFilter(): void
    {
        ...
        $profiles = ExternalProfile::withTrashed()->get();
    ...
    public function testOnlyTrashedFilter(): void
    {
        ...
        $profiles = ExternalProfile::onlyTrashed()->get();
    ...
    /**
     * The External Profile Index Endpoint shall support filtering by deleted_at.
     *
     * @return void
     */
    public function testDeletedAtFilter(): void
    {
        ...
        $profiles = ExternalProfile::withTrashed()->where(BaseModel::ATTRIBUTE_DELETED_AT, $deletedFilter)->get();
