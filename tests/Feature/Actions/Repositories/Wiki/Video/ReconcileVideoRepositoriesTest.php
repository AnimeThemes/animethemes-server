...
test('created', function (): void {
    ...
    expect($result->getCreated())->toHaveCount($createdVideoCount);
...
test('deleted', function (): void {
    ...
    expect($result->getStatus())->toBe(ActionStatus::PASSED);
    expect($result->hasChanges())->toBeTrue();
    expect($result->getDeleted())->toHaveCount($deletedVideoCount);
...
test('updated', function (): void {
    ...
    expect($result->getStatus())->toBe(ActionStatus::PASSED);
    expect($result->hasChanges())->toBeTrue();
    expect($result->getUpdated())->toHaveCount($updatedVideoCount);
